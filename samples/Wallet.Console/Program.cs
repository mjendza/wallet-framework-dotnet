...
serviceCollection.AddAriesFramework(builder =>
{
...
serviceCollection.AddOpenIdDefaultServices();
serviceCollection.AddScoped<IKeyStore, MockKeystore>();
var serviceProvider = serviceCollection.BuildServiceProvider();
var service = serviceProvider.GetService<IOid4VciClientService>();
var _oidIssuerMetadata = await service.FetchIssuerMetadataAsync(new Uri("https://test-not.xfsc.dev/oid4vci/"));
var code =
    "eyJr";
var result = await service.RequestCredentialAsync(_oidIssuerMetadata.CredentialConfigurationsSupported.First().Value,
    _oidIssuerMetadata, code, null);
